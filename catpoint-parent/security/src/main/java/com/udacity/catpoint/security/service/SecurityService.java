...
//        }else {
//            getSensors().forEach(sensor -> sensor.setActive(false));
//            if(armingStatus == ArmingStatus.ARMED_HOME && this.isCatDetected){
//                setAlarmStatus(AlarmStatus.ALARM);
//
//            }
//
...
//
// //           getSensors().forEach(sensor -> sensor.setActive(false));
//            if (armingStatus == ArmingStatus.ARMED_HOME && this.catFoundFlag) { // current status is armed home
...
//    }
     ...
     */
    private void isCatDetected(boolean cat){
        if (cat && getArmingStatus() == ArmingStatus.ARMED_HOME) {
            setAlarmStatus(AlarmStatus.ALARM);
        } else {
            setAlarmStatus(AlarmStatus.NO_ALARM);
        }
        this.catFoundFlag = cat;
...
//        if(cat && getArmingStatus() == ArmingStatus.ARMED_HOME){
//            setAlarmStatus(AlarmStatus.ALARM);
//        }else if(!cat && allSensorsMatchInputSensor(false)){
//            setAlarmStatus(AlarmStatus.NO_ALARM);
//        }
//       statusListeners.forEach(sl -> sl.catDetected(cat));
//
//    }
//
//    private boolean allSensorsMatchInputSensor(boolean sensorState) {
//        return getSensors().stream().allMatch(sensor -> sensor.getActive()==sensorState);
//    }
